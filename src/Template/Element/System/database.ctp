...
<div class="row">
    <div class="col-md-4">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?= __d('Qobo/ProjectTemplateCakephp', 'Database Summary') ?></h3>
            </div>
            <div class="box-body">
                <div class="info-box">
                    <span class="info-box-icon bg-blue"><i class="fa fa-database"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text"><?= __d('Qobo/ProjectTemplateCakephp', 'Database engine') ?></span>
                ...
                <div class="info-box">
                    <span class="info-box-icon bg-blue"><i class="fa fa-database"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text"><?= __d('Qobo/ProjectTemplateCakephp', 'Database size') ?></span>
                ...
                <div class="info-box bg-blue">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><?= __d('Qobo/ProjectTemplateCakephp', 'Total tables') ?></span>
                        ...
                        <span class="progress-description"><?= __d('Qobo/ProjectTemplateCakephp', '{0} system tables', count($skipTables)) ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?= __d('Qobo/ProjectTemplateCakephp', 'Table Records') ?></h3>
            </div>
            <div class="box-body">
                <?php foreach ($tableStats as $table => $stats) : ?>
                    ...
                    <div class="info-box bg-aqua">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?= __d('Qobo/ProjectTemplateCakephp', '{0} records', number_format($stats['total'])) ?></span>
                            <div class="progress">
                                <div class="progress-bar" style="width: <?php echo $this->SystemInfo->getProgressValue($stats['deleted'], $stats['total']); ?>"></div>
                            </div>
                            <span class="progress-description">
                                <?php __d('Qobo/ProjectTemplateCakephp', '{0} deleted records ({1})', number_format($stats['deleted']), $this->SystemInfo->getProgressValue($stats['deleted'], $stats['total'])) ?>
                            </span>
                        </div>
                    </div>
                <?php endforeach; ?>
    ...
    <div class="col-md-4">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?= __d('Qobo/ProjectTemplateCakephp', 'Table Sizes') ?></h3>
            </div>
            <div class="box-body">
                <?php foreach ($tableStats as $table => $stats) : ?>
                    <?php
